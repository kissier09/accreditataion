...
class InstituteController extends Controller
{
    ...
    {
        try {
            $institute = Institute::findOrFail($id); // Find the institute by ID or fail
            $institute->delete(); // Delete the institute

            return response()->json(['message' => 'Institute deleted successfully'], 200);
        } catch (\Throwable $e) {
            return response()->json(['message' => 'Failed to delete institute'], 400);
        }
    }
