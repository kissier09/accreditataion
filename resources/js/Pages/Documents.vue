...
<Layout :user="$page.props.user">
    <template #navSlot>
        <Link 
            ...
            :class="[$page.url.startsWith('/document/uploads') ? 'border-earistRed text-earistRed font-semibold':'group hover:border-earistRed border-transparent']"
        >
            <div class="rounded group-hover:bg-earistRed/20 group-hover:text-earistRed px-2 py-2.5 flex gap-2" title="Your uploads">
        ...
        <Link 
            :href="'/document/share'"
            class="h-full flex items-center border-b-[3px] justify-center mr-2.5 transition_300"
            :class="[$page.url.startsWith('/document/share') ? 'border-earistRed text-earistRed font-semibold':'group hover:border-earistRed border-transparent']"
        >
            <div class="rounded group-hover:bg-earistRed/20 group-hover:text-earistRed px-2 py-2.5 flex gap-2" title="Shared">
