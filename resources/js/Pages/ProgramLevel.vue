...
<Layout :user="$page.props.user">
    <template #navSlot>
        ...
        <div>
            <!-- Button to Open Task Force Modal -->
            <button @click="openTaskForceModal" class="open-modal-btn">Open Task Force List</button>

            <!-- Task Force Modal -->
            <TaskForceModalall ref="taskForceModalall" />
        </div>
...
import TaskForceModalall from '../Components/Program/ProgramLevel/TaskForce/TaskfoceModalall.vue'
...
const taskForceModalall = ref(null);

// Method to open the Task Force Modal
const openTaskForceModal = () => {
  taskForceModalall.value.openModal();
};
