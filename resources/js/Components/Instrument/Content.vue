    ...
    >
        <div class="flex grow" ref="contentContainer">
            ...
            >
                ...
                >
                    ...
                    <div class="ml-auto max-w-fit h-fit my-auto">
                        <button 
                            ...
                            :class="[active && index == storeDocument.evidenceIndex?'bg-earistRed text-white':'hover:bg-earistRed bg-green-600/20 hover:text-white text-green-700']"
                ...
                >
                    ...
                    <button 
                        ...
                        class="text-sm pointer-events-auto hover:bg-earistRed hover:text-white px-1.5 bg-green-600/20 rounded-full text-green-700"
                        @click="getEvidenceDocument(inst, index)"
                    >
                        Document
                    </button>
            ...
            <button
                ...
                class="h-fit text-xs hover:opacity-100 hover:text-white hover:bg-earistRed/80 px-1.5 py-1 
