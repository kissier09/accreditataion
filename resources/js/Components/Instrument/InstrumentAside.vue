    ...
    <Aside @handleClose="$emit('handleClose')">
        ...
        <div class="flex p-1.5 pb-0 gap-0.5">
            <button 
                ...
                :class="[isDetails? 'bg-earistRed/20 border-earistRed text-earistRed dark:bg-earistRed/30 dark:text-white/80' : 
            ...
            :class="[isActivity? 'bg-earistRed/20 border-earistRed text-earistRed dark:bg-earistRed/30 dark:text-white/80' : 
            'hover:bg-black/10 hover:border-black/40 dark:hover:bg-white/5 dark:hover:border-white/30 border-transparent']"
                @click="getActivity"
            >Activity</button>
        </div>
