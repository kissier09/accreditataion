        ...
        <div class="border border-slate-200 dark:border-primaryDarkBorder rounded-md mt-6 w-[35rem] flex" v-if="user != 'error' && user">
            ...
            <div class="p-3 grow">
                <form @submit.prevent="saveChanges" class="flex-col flex" v-if="!isChangePass">
                    ...
                    <button type="button" class="w-fit hover:text-earistRed transition_300" @click="isChangePass = true">Change password</button>
                </form>
                ...
                <form @submit.prevent="changePassword" class="flex-col flex" v-else>
                    ...
                    <button type="button" class="w-fit hover:text-earistRed transition_300" @click="isChangePass = false">Cancel</button>
                </form>
            </div>
        </div>
