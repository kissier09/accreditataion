<template>
    <div class="w-full h-14 bg-white fixed top-0 flex z-40 subnavBg">
        <div class="md:w-60 h-full flex items-center gap-2 px-3">
            ...
            <div class="inter-font font-semibold text-earistRed max-sm:hidden"> ACCREDITATION </div>
        </div>
        ...
        <div class="shink-0 h-full flex items-center px-2.5 gap-2 text-slate-500">
            ...
            transition duration-300 hover:dark:bg-white/20 hover:bg-earistRed/20 hover:text-earistRed dark:shadow-[inset_0_1px_0_0_hsl(0deg_0%_100%_/_5%)] relative"
                ...
                <div class="rounded-md bg-white myshadow dark:bg-tertiaryDarkBg py-2 absolute top-10 right-0 w-44 text-left z-50" v-if="isViewProfOpeion">
                    <ul>
                        ...
                        <li class="dark:hover:bg-white/10 hover:bg-gray-300/80 transition_300 cursor-pointer py-2 px-2 flex items-center gap-2" 
                            @click="enableDark"
                        >Dark mode <div class="w-2 h-2 rounded-full bg-earistRed" v-if="$page.props.theme"></div> </li>
                        <li class="dark:hover:bg-white/10 hover:bg-gray-300/80 transition_300 cursor-pointer py-2 px-2 flex items-center gap-2" 
                            @click="enableLight"
                        >Light mode <div class="w-2 h-2 rounded-full bg-earistRed" v-if="!$page.props.theme"></div> </li>
