    ...
    <AccredCard>
        ...
        :class="[selected === accredit.id?'card-select':' card-hover']">
            ...
            <div class="flex gap-1.5 absolute bottom-[0.30rem] right-11">
                <button class="p-0.5 rounded transition_300 hover:bg-earistRed hover:text-white"
            ...
            <button class="absolute bottom-1.5 right-3 px-1 rounded-xl transition_300 hover:bg-earistRed hover:text-white"
