    ...
    <AccordionContainer>
        <div 
            ...
            :class="
                ...
                [storeTaskPage.selected == inst.id && openDropDown ?'bg-earistRed/20 dark:bg-earistRed/40 dark:text-green-400 text-earistRed dark:border-green-900/80 border-earistRed/5':''],
                [storeTaskPage.selected == inst.id && !openDropDown ?'bg-earistRed/20 dark:bg-earistRed/40 dark:text-green-400 text-earistRed dark:border-green-900/80 border-earistRed/5':''],
                [storeTaskPage.selected != inst.id && openDropDown?'bg-earistRed/30 dark:bg- dark:text-green-400 text-earistRed dark:border-green-500/80 border-earistRed/80':'']
            "
            @contextmenu.self=""
        >
            ...
            <div class="w-fit h-fit shrink-0 flex gap-3 items-center ml-1">
                ...
                hover:bg-earistRed/80 hover:text-white actionBtn"
