        ...
        <div class="w-full pb-4">
            ...
            <div class="w-full h-fit">
                <div class="flex justify-center">
                    <div class="w-20 h-20 bg-earistRed/90 shrink-0 rounded-full relative grid place-items-center progress dark:before:bg-tertiaryDarkBg before:bg-white" ref="progressBar">
