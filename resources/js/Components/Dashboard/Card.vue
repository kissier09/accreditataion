<template>
    <div class="w-full">
        ...
        @click.self="clusterAccred">
            ...
            <button @click="reloadArea" class="text-xs p-0.5 px-1 rounded transition_300 hover:bg-earistRed hover:text-white">
                reload
            </button>
        </div>
        ...
        >
            ...
            <div class="pb-1">
                <div 
                    ...
                    :class="[selectedArea == area.id? 'dark:bg-earistRed bg-earistRed/20 text-earistRed dark:text-white' : 'bg-gray-200 hover:bg-gray-300/80 hover:dark:bg-white/20 dark:bg-tertiaryDarkBg']"
