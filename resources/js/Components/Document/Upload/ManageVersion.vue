    ...
    >
        ...
        <div class="max-h-[80vh] min-h-[40vh] pb-3">
            <div class="flex justify-end py-4">
                <button 
                    class="rounded-md inter-font bg-earistRed/90 hover:bg-earistRed transition_300 hover:shadow-md dark:shadow-[inset_0_1px_0_0_hsl(0deg_0%_100%_/_5%)] h-9 px-2 text-white"
