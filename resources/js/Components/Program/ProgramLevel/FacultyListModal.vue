<template>
    <Modal width="w-[33rem]" @handleClose="$emit('handleClose')">
        ...
        <div v-if="!isAddFS">
            ...
            <div class="w-full h-10 dark:text-white/80 text-white bg-earistRed rounded-md">
                ...
                <div class="min-h-fit overflow-y-auto grow p-1 flex flex-col gap-1">
                    ...
                    v-for="(fs, index) in faculties" :key="index">
                        ...
                        <div class="flex items-center justify-center" v-if="false">
                            <button 
                                class="w-fit px-2 py-px rounded bg-earistRed disabled:bg-tertiaryDarkBg disabled:dark:text-white/30" 
