    ...
    <AccordionContainer>
        <div class="w-full min-h-[2rem] rounded-md border border-transparent flex items-center justify-between p-2 transition duration-300"
            ...
            :class="
                ...
                [storeProgLvl.selected == inst.id && openDropDown ?'bg-earistRed/20 dark:bg-earistRed/40 dark:text-green-400 text-earistRed dark:border-green-900/80 border-earistRed/5':''],
                [storeProgLvl.selected == inst.id && !openDropDown ?'bg-earistRed/20 dark:bg-earistRed/40 dark:text-green-400 text-earistRed dark:border-green-900/80 border-earistRed/5':''],
                [storeProgLvl.selected != inst.id && openDropDown ?'bg-earistRed/30 dark:bg- dark:text-green-400 text-earistRed dark:border-green-500/80 border-earistRed/80':'']
            "
            @contextmenu.self=""
