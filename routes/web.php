...
Route::get('/redirect', [AuthController::class, 'redirects'])->name('auth.redirect');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['admin'])->group(function () {
        ...
        Route::controller(AccreditationController::class)->group(function () {
            ...
            Route::delete('/accreditation/delete_tag_program', [AccreditationController::class, 'deleteTagProgram']);
        });
        
        //instrument routes
        Route::controller(InstrumentController::class)->group(function () {
          
            Route::get('/program/instrument', 'index')->name('instrument_indx');
            Route::get('/program/instrument/inst/{id?}', 'index')->name('instrument_indx2');
            Route::get('/program/instrument/exclude/{inst}', 'excludeInComputation');
    ...
    Route::controller(InstrumentController::class)->group(function () {
        ...
        Route::post('/program/instrument/delete', [InstrumentController::class, 'delete']);
    ...
    Route::controller(AccreditorController::class)->group(function () {
        ...
        Route::delete('/program/delete/accreditor', [AccreditorController::class, 'deleteAccreditor']);
        Route::post('/program/remove/selfAccreditor', [AccreditorController::class, 'removeAccreditor'])->name('remove.self.accreditor');
    ...
    Route::controller(InstrumentCommentController::class)->group(function () {
        ...
        Route::post('/comment/update-status', [InstrumentCommentController::class, 'updateStatus']);
    ...
    Route::controller(ProgramController::class)->group(function () {
        ...
        // web.php (routes file)
        Route::get('/program/getTaskForces', [ProgramController::class, 'getTaskForces']);
...
// routes/web.php or routes/api.php (depending on your setup)
    ...
    Route::controller(UserController::class)->group(function () {
        ...
        Route::delete('/user/delete/{id}', [UserController::class, 'delete'])->withoutMiddleware('auth');
